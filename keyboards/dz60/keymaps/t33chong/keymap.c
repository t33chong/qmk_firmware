...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT_t33chong(
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          _MEHMIN, \
    ...
    /* _MEHHYP, KC_LALT, KC_LGUI,          KC_LSFT,          _MO_NUM,          _METSPC,          _UNDSCR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \ */
    _PUSHTT, KC_LALT, KC_LGUI,          KC_LSFT,          _MO_NUM,          _METSPC,          _UNDSCR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  [_META] = LAYOUT_t33chong(
    ...
    _______, _______, _______,          _TO_ARR,          _TO_MSK,          _______,          _______, _______, _______, _______, _______  \
  ),
  ...
  [_MOUSEKEYS] = LAYOUT_t33chong(
    ...
    XXXXXXX, XXXXXXX, KC_LGUI,          KC_BTN2,          KC_BTN3,          KC_BTN1,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX  \
  ),
...
/* bool _was__METMIN_used_as_KC_BSLS; */
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    /*   if (_is_gui_held && record->event.pressed) { // Restore backslash key to original function when gui is held */
    /*     register_code(KC_BSLS); */
    /*     _was__METMIN_used_as_KC_BSLS = true; */
    /*     return false; */
    /*   } */
    /*   if (_was__METMIN_used_as_KC_BSLS && !record->event.pressed) { */
    /*     unregister_code(KC_BSLS); */
    /*     _was__METMIN_used_as_KC_BSLS = false; */
    /*     return false; */
    /*   } */
    /*   return true; */
    /* case _TGMOUS: */
    ...
    default:
      if (_current_layer == _MEH) {
        /* if (keycode == _MEHSPC || keycode == _MO_MEH) { */
        if (keycode == _MEHMIN) {
          return true;
        }
        if (record->event.pressed) {
        ...
        /* if (keycode == _HYPEQL || keycode == _MO_HYP) { */
        if (keycode == _HYPEQL) {
          return true;
        }
        if (record->event.pressed) {
