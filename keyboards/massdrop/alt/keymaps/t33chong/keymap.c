...
enum my_keycodes {
    ...
    /* MY_ALBS, */
    /* MY_TGGA //Toggle gaming layer */
};

/* // Tap Dance definitions */
/* qk_tap_dance_action_t tap_dance_actions[] = { */
/*     // Tap once for Escape, twice for Caps Lock */
/*     [MY_TGGA] = ACTION_TAP_DANCE_DOUBLE(TG(3), TG(0)), */
/* }; */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        MY_SFBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MY_SFEQ,          KC_UP,   KC_PGDN, \
        /* KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MY_SFEQ,          KC_UP,   KC_PGDN, \ */
